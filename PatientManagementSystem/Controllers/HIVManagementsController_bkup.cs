...
{
    public class HIVManagementsController1 : Controller
    {
        ...
        public ActionResult HIVIndex(int id)
        {
            ...
            {
                List<HIVManagement> hivMan = db.HIVManegements.ToList();
                var hList = hivMan.Where(h => h.PatientId == id);
        ...
        public ActionResult Create([Bind(Include = "Id,PatientId,HIVDiagnosis,TCellAtDiagnosis,ViralLoadAtDiagnosis")] HIVManagement hIVManagement)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,PatientId,HIVDiagnosis,TCellAtDiagnosis,ViralLoadAtDiagnosis")] HIVManagement hIVManagement)
        {
            if (ModelState.IsValid)
            {
