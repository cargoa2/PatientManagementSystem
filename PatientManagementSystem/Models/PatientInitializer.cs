            ...
            var visits = new List<Visits>
                        {
                            new Visits {PatientId = 1,
                                        ...
                                        Documentsoratory = "This test for 1.",
                                        PeGeneral = "Good",
                    ...
                    {  new HIVManagement
                        {
                            ...
                            MedDiscDate = Convert.ToDateTime("2015/7/1")
                        },
                        new HIVManagement {                          
                            PatientId = 1,                           
                            Problem = "Medicationis not working",
                            ICD10 = "200.20",
                            MedicationStart = Convert.ToDateTime("2016/7/1"),
            ...
            var other = new List<OtherManagement>
                        {
                            ...
                            Triglycerides = 50,
                            TotalCholesterol = 20,
                            OtherDocuments = "Documents for patient 1 first Documents"
                            },
                            new OtherManagement
                            {
                            PatientId = 1,
